...
const CreatePoint = () => {
  ...
  const [initialPosition, setInitialPosition] = useState<[number, number]>([-30.0277, -51.2287]);
  ...
  useEffect(() => {
    ...
    axios.get<IBGECityResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`)
      .then(response => {
        const citiesFromUf = response.data.map(city => city.nome);
        
        setCities(citiesFromUf);
      })
  }, [selectedUf]);
